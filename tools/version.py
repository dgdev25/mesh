"""
Version Tool - Display Mesh MCP Server version and system information

This tool provides version information about the Mesh MCP Server including
...
def fetch_github_version() -> Optional[tuple[str, str]]:
    ...
    github_url = "https://raw.githubusercontent.com/ruvnet/mesh/main/config.py"
...
class VersionTool(BaseTool):
    """
    Tool for displaying Mesh MCP Server version and system information.
    ...
    async def execute(self, arguments: dict[str, Any]) -> list[TextContent]:
        """
        Display Mesh MCP Server version and system information.
        ...
        """
        output_lines = ["# Mesh MCP Server Version\n"]
        ...
        try:
            ...
            provider_names = ["Gemini CLI", "Codex CLI", "OpenRouter"]
