...
class ChatTool(SimpleTool):
        ...
        if self._model_supports_code_generation():
            ...
            if block:
                ...
                try:
                    ...
                    warning = (
                        f"WARNING: Unable to write mesh_generated.code inside '{target_directory}'. "
                    ...
                    if not sanitized_text:
                        base_message = (
                            "Generated code saved to mesh_generated.code.\n"
                            "\n"
    ...
    def _persist_generated_code_block(self, block: str, working_directory: str) -> Path:
        ...
        target_file = target_dir / "mesh_generated.code"
        if target_file.exists():
            try:
                target_file.unlink()
            except OSError as exc:
                logger.warning("Unable to remove existing mesh_generated.code: %s", exc)
