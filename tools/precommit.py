...
class PrecommitRequest(WorkflowRequest):
    ...
    include_unstaged: bool | None = Field(
...
class PrecommitTool(WorkflowTool):
    ...
    def get_completion_next_steps_message(self, expert_analysis_used: bool = False) -> str:
        ...
        """
        base_message = (
            "PRE-COMMIT VALIDATION IS COMPLETE. You may delete any `mesh_precommit.changeset` created. You MUST now summarize "
        ...
        if step_number == 1:
            if is_external_continuation:
                ...
                next_steps = (
                    ...
                    + "\\n\\nMANDATORY: The changeset may be large. You MUST save the required changeset as a 'mesh_precommit.changeset' file "
            ...
            if (
                ...
                next_steps = (
                    ...
                    f"changeset as a 'mesh_precommit.changeset' file (replacing any existing one) in your work directory "
            ...
            if not request.next_step_required and request.precommit_type == "external":
                ...
                next_steps = (
                    ...
                    "MANDATORY: Save the complete git changeset as a 'mesh_precommit.changeset' file "
            ...
            if (
                ...
                next_steps = (
                    ...
                    "MANDATORY: Save complete git changeset as 'mesh_precommit.changeset' file and include path in relevant_files, "
