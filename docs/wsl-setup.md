...
- Always use the full WSL path for MCP configuration (e.g., `/home/YourName/mesh/`)
...
# Example: "/home/YourName/mesh/.mesh_venv/bin/python"
```

### Performance Tip

For best performance, keep your mesh directory in the WSL filesystem (e.g., `~/mesh`) rather than in the Windows filesystem (`/mnt/c/...`).